  ...
  return [
    { title: `${collectionTitle} | Klosslabbet` },
    {
      ...
      content: data?.collection?.description 
        ? `${data?.collection?.description} ✓ ${productCount}+ produkter ✓ Fri upphämtning över 1299 kr ✓ Säker betalning`
        : `Upptäck ${collectionTitle} med ${productCount}+ produkter. ✓ Fri upphämtning över 1299 kr ✓ 14 dagars öppet köp ✓ Snabb leverans`,
    },
    {
      tagName: 'link',
      rel: 'canonical',

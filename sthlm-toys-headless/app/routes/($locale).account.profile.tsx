              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3">
                  ...
                  <Link
                    ...
                    className="px-4 py-2 border border-blue-300 text-blue-700 font-medium rounded-md hover:bg-blue-100 transition-colors text-sm"
                  >
                    Integritetspolicy
                  </Link>
                </div>

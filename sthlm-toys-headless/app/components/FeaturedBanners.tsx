...
// ✅ PERFORMANCE OPTIMIZED: Added responsive images with WebP format
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{height: '400px'}}
                  >
                    {/* ✅ OPTIMIZED: Desktop images with srcset */}
                    {imageUrl ? (
                      isShopifyImage ? (
                        <picture>
                          <source
                            srcSet={getImageSrcSet(imageUrl, [400, 600, 800])}
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{height: '200px'}}
                  >
                    {/* ✅ OPTIMIZED: Mobile images with srcset */}
                    {imageUrl ? (
                      isShopifyImage ? (
                        <picture>
                          <source
